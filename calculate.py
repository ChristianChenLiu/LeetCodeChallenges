class Solution:
    def calculate(self, s: str) -> int:
    	...
    	### Note that we initialize with 1 to represent '+'
        ...
        for c in s:
            ...
            ### When we see '+', we need to mutiple the current number we are holding with the 
            ...
            ### (1) pop the last element and combine it with the current num and sign we are holding (the last element inside this '()' ).
